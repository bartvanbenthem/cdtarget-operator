...
func (r *CDTargetReconciler) updateConfigMapForCDTarget(t *cnadv1alpha1.CDTarget, cm *v1.ConfigMap) *v1.ConfigMap {
	ls := t.Spec.PodSelector
	name := "cdtarget-config"
...
func (r *CDTargetReconciler) updateDeploymentForCDTarget(t *cnadv1alpha1.CDTarget, dep *appsv1.Deployment) *appsv1.Deployment {
	ls := t.Spec.PodSelector
	replicas := t.Spec.MinReplicaCount
